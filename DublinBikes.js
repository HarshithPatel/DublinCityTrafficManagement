...
function populateTable(markerName, markerAvailabele, markerTotal) {
  ...
  data: [{
    ...
    indexLabel: "{label} {y}",
    dataPoints: [
    {y: markerAvailabele, label: "Available"},
    {y: (markerTotal-markerAvailabele), label: "Not Available"},
...
document.getElementById("Busy_Station").innerHTML = "The Busiest Station right now is  " + redarray;
